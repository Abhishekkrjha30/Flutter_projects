  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text('Link New Account ',style: TextStyle(color: Colors.white),)),
          actions: [
            ...
            child: Row(
              ...
              children: [
                TextButton(onPressed: (){}, child:
                    Column(
                      children: [
                        Icon(Icons.verified_user_outlined,color: Colors.red.shade900,),
                        Text('Vanquard',style: TextStyle(color: Colors.grey,fontSize: 16),),
                      ],
                    )
                ),
                TextButton(onPressed: (){}, child:
    ...
    Text('Robinhood',style: TextStyle(color: Colors.grey,fontSize: 16),),
      ...
      Column(
        children: [
          Icon(Icons.maps_home_work_outlined,color: Colors.indigo,size: 60,),
