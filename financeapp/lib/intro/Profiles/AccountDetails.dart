...
class AccountDetailsState extends State<AccountDetails>{
  ...
  Widget build(BuildContext context) {
    ...
    trailing:Text('Will',style: TextStyle(fontSize: 20),),
    ),
    Divider(
    indent: 25,
    endIndent: 25,
      ...
      ListTile(
        ...
        trailing:Text('Kim',style: TextStyle(fontSize: 20),),
      ),
      Divider(
        indent: 25,
        endIndent: 25,
      ...
      ListTile(
        ...
        trailing: Text('wikim',style: TextStyle(fontSize: 20,color: Colors.grey),),
      ),
      Divider(
        indent: 25,
          endIndent: 25,
      ...
      Container(
        ...
        child: ListTile(
          ...
          trailing: Text("will@gmail.com",style: TextStyle(fontSize: 20),),
        ),
      )
