  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('My Profile',style: TextStyle(letterSpacing: 0.6,fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
      drawer:DrawerPage(),
      body: Column(
        children: [
          ...
          Container(
            ...
            }, child:Text("Log Out",style: TextStyle(fontSize: 18,color: Colors.black,fontWeight: FontWeight.bold),) ),
          )
