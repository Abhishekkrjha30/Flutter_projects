                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                          ...
                          label:Text( "Email Address",style: TextStyle(fontSize: 15,color: Colors.grey),),
                        ),
                      ),
                    ),
                    SizedBox(height: 16,),
                    ...
                    TextButton(onPressed: (){
                       Navigator.of(context).push(MaterialPageRoute(builder: (context)=>SignUpWithPhone(),),);

                    },
                        child:Text("Sign up with phone number",style: TextStyle(fontSize: 16,color:Colors.blue,fontWeight: FontWeight.bold,letterSpacing: 1),),
                    ),
                    SizedBox(height: 20,)
