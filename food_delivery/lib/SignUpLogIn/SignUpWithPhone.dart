...
class SignUpWithPhoneState  extends State{
  @override
      ...
      body:Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                    Padding(
                      padding: const EdgeInsets.only(right: 140,bottom: 20),
                ...
                child: Column(
                  children: [
                    ...
                    TextButton(onPressed: (){},
                        child:Text("Sign up with E-mail",style: TextStyle(fontSize: 16,color:Colors.blue,fontWeight: FontWeight.bold,letterSpacing: 1),),
                    ),
